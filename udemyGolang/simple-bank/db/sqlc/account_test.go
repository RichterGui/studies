...
func TestUpdateAccount(t *testing.T) {
	...
	require.Equal(t, newBalance, fetchedAccount.Balance)
	require.Equal(t, account1.Currency, fetchedAccount.Currency)
	require.WithinDuration(t, account1.CreatedAt, fetchedAccount.CreatedAt, time.Second)
}
